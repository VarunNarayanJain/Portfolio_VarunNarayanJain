    ...
    <section className="min-h-screen w-full py-20 px-6 md:px-20 flex items-center relative z-10 pointer-events-none">
      <div className="max-w-5xl mx-auto pointer-events-auto">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="text-accent font-mono text-sm mb-6 block drop-shadow-md font-medium"
        >
          01. ABOUT
        </motion.span>
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-6xl font-serif mb-12 text-white drop-shadow-lg"
        >
          Engineering with <br />
        ...
        <motion.div 
          ...
          className="text-sm md:text-lg text-gray-100 leading-relaxed space-y-8 drop-shadow-md bg-black/30 backdrop-blur-md p-8 rounded-xl border border-white/10"
        >
          <p>
