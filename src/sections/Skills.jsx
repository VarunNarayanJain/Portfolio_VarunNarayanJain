    ...
    <section className="min-h-screen w-full py-20 px-6 md:px-20 relative z-10 pointer-events-none">
      <div className="max-w-7xl mx-auto pointer-events-auto">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="text-accent font-mono text-sm mb-10 block drop-shadow-md font-medium"
        >
          02. SKILLS
        </motion.span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {skills.map((group, index) => (
            ...
            >
              <h3 className="text-lg font-serif mb-8 text-white drop-shadow-lg">{group.category}</h3>
