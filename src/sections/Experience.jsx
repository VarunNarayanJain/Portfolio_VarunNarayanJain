    ...
    <section className="w-full py-20 px-6 md:px-20 relative z-10 pointer-events-none">
      <div className="max-w-5xl mx-auto pointer-events-auto">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="text-accent font-mono text-sm mb-16 block drop-shadow-md font-medium"
        >
        ...
        <div className="space-y-20">
          {/* Experience */}
          <div>
            <h3 className="text-xl font-serif text-white mb-10 drop-shadow-lg">Experience</h3>
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">{exp.role}</h4>
                  <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 text-xs font-mono text-gray-200">
          ...
          {/* Education */}
          <div>
            <h3 className="text-xl font-serif text-white mb-10 drop-shadow-lg">Education</h3>
            <div className="space-y-8">
              {education.map((edu, index) => (
                ...
                >
                  ...
                  <div className="text-accent font-mono text-sm mb-3 font-medium">{edu.degree}</div>
                  {edu.details && <div className="text-gray-200 text-xs">{edu.details}</div>}
                </motion.div>
              ))}
            </div>
          </div>
          ...
          {/* Achievements */}
          <div>
            <h3 className="text-xl font-serif text-white mb-10 drop-shadow-lg">Achievements</h3>
            <ul className="space-y-6">
              {achievements.map((item, index) => (
                <motion.li 
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="flex items-start gap-4 text-gray-100 text-sm"
                >
          ...
          {/* Positions */}
          <div>
            <h3 className="text-xl font-serif text-white mb-10 drop-shadow-lg">Positions of Responsibility</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {positions.map((pos, index) => (
                ...
                >
                  ...
                  <div className="text-accent text-xs mb-3 font-medium">{pos.org}</div>
                  <div className="text-[10px] font-mono text-gray-400 mb-5">{pos.period}</div>
